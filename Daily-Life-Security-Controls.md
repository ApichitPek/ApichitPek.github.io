...
# เหตุผลที่จัดอยู่ในหมวดนี้เป็นเพราะ
   ...
   # 2. ทำหน้าที่เป็น Detective Function (การตรวจจับ)
   ...
   # 3. สามารถมองเป็น Corrective ได้ด้วย
        + ในตัวอีเมลจะมีปุ่ม "ตรวจสอบกิจกรรม" ซึ่งหากคุณคลิกเข้าไปแล้วแจ้งว่า "ไม่ใช่ฉัน" ระบบจะเข้าสู่โหมด Corrective (การแก้ไข) ทันที เช่น:
